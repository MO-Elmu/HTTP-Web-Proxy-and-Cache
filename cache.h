 ...
 */
  ...
  /*maintain an array of 997 mutexes, and before doing anything on behalf of a particular 
    request, hash it and acquire the mutex at the index equal to the hash code modulo 997*/

  std::mutex requests[997]; 
